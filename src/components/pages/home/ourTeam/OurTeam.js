...
const OurTeam = () => {
    ...
    return (
        <>
            <div className=" bg-gray-50 pb-10 sm:mb-2">
                        ...
                        <div className="flex items-center justify-center">
                            ...
                            <div className="flex overflow-visible space-x-6">
                                {team.slice(currentIndex, currentIndex + itemsToShow).map((member) => (
                                    ...
                                    >
                                        <div className="relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 hover:shadow-2xl transform hover:-translate-y-2">
                                            <div className="relative">
                                                <img
                                                    src={member.photo}
                                                    alt={member.name}
                                                ...
                                                {hoveredMember === member.name && (
                                                    <div className="absolute inset-0 bg-blue-600 bg-opacity-70 rounded-2xl flex flex-col justify-between p-6 text-white transition-all duration-500">
