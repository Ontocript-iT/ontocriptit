...
`}
            ...
            <div className="relative z-10 max-w-4xl px-8 text-left md:px-16">
                ...
                >
                    At OntocriptiT, we specialize in creating tailored web, mobile, and cloud solutions that drive business success. Our commitment to innovation and customer satisfaction ensures we deliver high-quality software to meet your unique needs              </motion.p>
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
