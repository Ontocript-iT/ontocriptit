...
const TopHero = () => {
  ...
  return refine(idea);
            ...
            <div className="relative z-10 max-w-4xl px-8 text-left md:px-16">
                ...
                >
                    Get in touch with us to bring your ideas to life. We specialize in developing innovative software solutions across web, mobile, and cloud platforms, tailored to meet your business needs                </motion.p>
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
