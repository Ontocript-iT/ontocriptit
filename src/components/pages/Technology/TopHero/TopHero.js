...
const TopHero = () => {
  ...
  return refine(idea);
            ...
            <div className="relative z-10 text-left px-8 md:px-16 max-w-4xl">
                ...
                >
                    Runs on these Latest Technologies
                </motion.h1>
                <motion.p
                ...
                >
                    Empower your product with cutting-edge technologies including Angular and React.js for dynamic frontend experiences, Spring Boot for robust backend development, and MySQL and MongoDB for efficient data management. Leverage the scalability and reliability of AWS and Firebase to ensure seamless performance and enhanced user experiences              </motion.p>
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
