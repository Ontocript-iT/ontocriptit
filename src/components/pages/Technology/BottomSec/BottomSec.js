    ...
    <div className='tech-bottom-container'>
      ...
      <div>
        <div className='tech-bottom-right'>
          ...
          <div>
            <h1 className='tech-bottom-heading' style={{ marginTop: "10px", marginLeft: "20px" }}>Performance<FontAwesomeIcon className='tech-icons' icon={faChartLine} /></h1>
          ...
          <div>
            <h1 className='tech-bottom-heading' style={{ marginTop: "10px", marginLeft: "20px" }}>Security<FontAwesomeIcon className='tech-icons' icon={faShieldAlt} /></h1>
          ...
          <div>
            <h1 className='tech-bottom-heading' style={{ marginTop: "10px", marginLeft: "20px" }}>Flexibility<FontAwesomeIcon className='tech-icons' icon={faRandom} /></h1>
