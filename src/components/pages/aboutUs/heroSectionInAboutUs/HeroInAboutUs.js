...
`}
            ...
            <div className="relative z-10 max-w-4xl px-8 text-left md:px-16">
                ...
                >
                    Ontocript IT (Pvt) Ltd, we turn ideas into impactful software. Specializing in web, mobile, and cloud technologies, we deliver tailored solutions to meet your business needs, with a focus on innovation and customer satisfaction              </motion.p>
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
