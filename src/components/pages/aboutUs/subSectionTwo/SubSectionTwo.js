    ...
    <div className='main-container'>
      ...
      <div className='sub-container'>
        ...
        <p className='sub-content'>we specialize in custom software development, responsive web and mobile apps, UI/UX
          ...
          business success. <span>More Details...</span></p>
        <hr style={{backgroundColor: "white",height:"1px"}}></hr>

        <h1 className='sub-head-topic'>What are Technologies We Use</h1>
        <p className='sub-content'>We leverage cutting-edge technologies and frameworks to develop innovative software
          solutions, including languages like Java, Python, JavaScript, and frameworks such as React, Angular, and
          Django. <span>More Details...</span></p>
        ...
        <p className='sub-content'>our insightful blogs delve into industry trends, best practices, and innovative
          ...
          strategies to stay informed and inspired. <span>More Details...</span></p>
